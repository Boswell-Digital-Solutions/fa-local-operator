...
- broad cross-service adapter integrations beyond the Cortex Gnat proving slice above (which itself still has no export sink for its forensic events); NeuronForge-Local and DF-Local integrations are unstarted
