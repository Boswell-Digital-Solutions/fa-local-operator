...
- broad cross-service adapter integrations beyond the Cortex Gnat proving slice above (which itself still has no forensic recording and no deadline/timeout enforcement on the dispatch subprocess call); NeuronForge-Local and DF-Local integrations are unstarted
