...
- declared-fallback coordination across steps dispatched to different adapters, and wiring per-step multi-adapter dispatch as the pipeline's/CLI's chosen coordination mode
